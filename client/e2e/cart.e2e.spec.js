...
test.describe("Shopping Cart", () => {
  ...
  test("should redirect to /checkout when Proceed to Checkout is clicked", async ({
    page,
  }) => {
    await addFirstAvailableProductToCart(page);
  ...
  test("should redirect unauthenticated user to login when clicking Add to Cart", async ({
    page,
  }) => {
    // Logout first
