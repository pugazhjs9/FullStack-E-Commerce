...
function TestConsumer() {
    const { cart, loading, addToCart, updateQuantity, removeFromCart, clearCart } = useCart();
    return (
        <div>
...
const mockCartData = { items: [{ productId: 1, quantity: 2, product: { id: 1, name: 'Laptop', price: 999.99 } }], itemCount: 2, subtotal: 1999.98 };
