...
test.describe("Products", () => {
  ...
  test("should navigate to the products listing page via nav", async ({
    page,
  }) => {
    await page.goto("/");
  ...
  test("should display product cards on the products page", async ({
    page,
  }) => {
  ...
  test("should navigate to product detail page when clicking a product", async ({
    page,
  }) => {
    await page.goto("/products");
  ...
  test("should show product name and price on detail page", async ({
    page,
  }) => {
    await page.goto("/products");
  ...
  test("should show all products when navigating to /products", async ({
    page,
  }) => {
    await page.goto("/products");
